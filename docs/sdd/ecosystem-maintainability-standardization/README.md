...
The production adapter and isolated GTK probes have clear mutation boundaries, but CMake defaults point at repository build artifacts and the repository has no local Task capability interface.
